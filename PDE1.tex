...
Consider $f_{\delta}\left(\xi\right):=\xi^{2q}e^{-\delta\xi}$, in
particular $f\in C^{2}\left(\mathbb{R}_{0}^{+}\right)$. The derivative
\begin{align*}
f_{\delta}'\left(\xi\right) & =\left(2q\right)\xi^{2q-1}e^{-\delta\xi}-\delta\xi^{2q}e^{-\delta\xi}
\end{align*}
is bounded. Due to $q>\frac{1}{2}$ follows $2q-1>0$. Choose $\varphi=f_{\delta}'\left(u\right)\cdot\eta^{2}$
with $\eta\in H_{0}^{1,2}$ as the test function, which is possible
since $f_{\delta}'\left(u\right)$ is bounded. The weak equation is:
\begin{align*}
\int a^{ij}\left(\partial_{i}u\right)\left(\partial_{j}\varphi\right) & \le0\qquad\fall_{\varphi\in H_{0}^{1,2}\left(\Omega\right)}
\end{align*}
This gives for our test function:
\begin{align*}
0 & \ge\int_{\Omega}a^{ij}\left(\partial_{i}u\right)\left(f_{\delta}''\left(u\right)\left(\partial_{j}u\right)\eta^{2}+f_{\delta}'\left(u\right)\cdot2\eta\partial_{j}\eta\right)
\end{align*}
\begin{align*}
f_{\delta}''\left(u\right) & =\left(\left(2q\right)\left(2q-1\right)u^{2q-2}-2\cdot2q\delta u^{2q-1}+\delta^{2}u^{2q}\right)e^{-\delta u}
\end{align*}
We use:
\begin{align*}
\partial_{j}v & =qu^{q-1}\partial_{j}u
\end{align*}
\begin{align*}
a^{ij}\left(\partial_{i}u\right)\left(\partial_{j}u\right)f_{\delta}''\left(u\right) & =\frac{2q\left(2q-1\right)}{q^{2}}a^{ij}\left(\partial_{i}v\right)\left(\partial_{j}v\right)e^{-\delta u}+\delta\left(\ldots\right)e^{-\delta u}\ge\\
 & \ge2\lambda\frac{2q-1}{q}\norm{\DD v}^{2}e^{-\delta u}+\delta\left(\ldots\right)e^{-\delta u}
\end{align*}
\begin{align*}
\left(\partial_{i}u\right)f_{\delta}'\left(u\right) & =\left(\partial_{i}u\right)\left(2qu^{2q-1}-\delta u^{2q}\right)e^{-\delta u}=2\left(\partial_{i}v\right)ve^{-\delta u}-\delta\left(\ldots\right)e^{-\delta u}
\end{align*}
Leave out the correction terms $\delta\left(\ldots\right)e^{-\delta u}$.
\begin{align*}
2\lambda\frac{2q-1}{q}\int_{\Omega}\norm{\DD v}^{2}\eta^{2} & \le\int a^{ij}2\left(\partial_{i}v\right)v\cdot2\eta\partial_{j}\eta\le\\
 & \le2\Lambda\left(\frac{1}{\kappa}\int\norm{\DD v}^{2}\eta^{2}+\kappa\int v^{2}\norm{\DD\eta}^{2}\right)
\end{align*}
Choose:
\begin{align*}
\frac{4\Lambda}{\kappa} & :=2\lambda\frac{2q-1}{q}\\
\kappa & =\frac{\Lambda}{\lambda}\frac{2q}{2q-1}
\end{align*}
\begin{align*}
\lambda\frac{2q-1}{q}\int_{\Omega}\norm{\DD v}^{2}\eta^{2} & \le2\Lambda\kappa\int v^{2}\norm{\DD\eta}^{2}\\
\int_{\Omega}\norm{\DD v}^{2}\eta^{2} & \le\left(\frac{\Lambda}{\lambda}\frac{2q}{2q-1}\right)^{2}\int v^{2}\norm{\DD\eta}^{2}
\end{align*}
\qqed

Proceed with the proof of Theorem \ref{sub:Thm-Moser-2}:
...
\end{align*}
Choose $0<r'<r<2r'<2$ and a test function $\eta\in C_{0}^{\infty}\left(B_{2}\left(0\right)\right)$
...
yields:
\begin{align*}
\int_{B_{r'}}\norm{\DD v}^{2}\le\int_{\Omega}\norm{\DD v}^{2}\eta^{2} & \le C\left(\frac{2q}{2q-1}\right)^{2}\int_{\Omega}\norm{\DD\eta}^{2}v^{2}\\
\int_{B_{r'}}\norm{\DD v}^{2} & \le C\left(\frac{2q}{2q-1}\right)^{2}\frac{4}{\left(r-r'\right)^{2}}\int_{B_{r}}v^{2}
\end{align*}
...
\begin{align*}
\left(\fint_{B_{r'}}v^{\frac{2n}{n-2}}\right)^{\frac{n-2}{2n}\cdot2} & \le\frac{1}{\left(r'\right)^{n}}\norm v_{H^{1,2}\left(B_{r'}\right)}^{2}=\frac{1}{\left(r'\right)^{n}}\int_{B_{r'}}\norm{\DD v}^{2}+\frac{1}{\left(r'\right)^{n}}\int_{B_{r'}}v^{2}\le\\
 & \le C\left(\frac{2q}{2q-1}\right)^{2}\frac{4}{\left(r-r'\right)^{2}}\frac{1}{\left(r'\right)^{n}}\int_{B_{r}}v^{2}\dd^{n}x+\frac{1}{\left(r'\right)^{n}}\int_{B_{r'}}v^{2}
\end{align*}
\begin{align*}
\left(\fint_{B_{r'}}v^{\frac{2n}{n-2}}\right)^{\frac{n-2}{2n}} & \le\overline{C}\int_{B_{r}}v^{2}\\
\overline{C} & =C\left(n,\frac{\lambda}{\Lambda}\right)\left(\left(\frac{r'}{r-r'}\right)^{2}\left(\frac{2q}{2q-1}\right)^{2}+1\right)
\end{align*}
