...
\frac{R^{2}-y^{2}}{n\omega_{n}R}\int_{B_{R}\left(0\right)}\frac{\varphi\left(x\right)}{\norm{x-y}^{n}}\dd\mu_{\partial B_{R}\left(0\right)} & \text{if }y\in B_{R}\left(0\right)\\
...
\subsection{Theorem \textmd{(Weak Maximum Principle)}}
...
\chapter{The Perron Method of Sub- and Supersolution}
...
\end{align*}
This works for any domain and gives a harmonic function, but $\partial\Omega$
