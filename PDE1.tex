...
\section{Definition \textmd{(Outer Sphere/Cone Condition)}}

An open subset $\Omega\subseteq\mathbb{R}^{n}$ satisfies in $\xi\in\partial\Omega$
the \emph{outer sphere condition} if there is a closed ball $K\subseteq\mathbb{R}^{n}$
...
\noindent \centering{}\caption{Outer Sphere Condition}
\end{figure}
...
An improvement is the so called \emph{outer cone condition}.
...
\noindent \centering{}\caption{Outer Cone Condition}
\end{figure}
...
\section{Definition \textmd{(Inner Sphere Condition)}}

A boundary point $x_{0}\in\partial\Omega$ satisfies the \emph{inner
...
\noindent \centering{}\caption{Inner sphere condition}
\end{figure}
...
\item The inner sphere condition is satisfied.
\end{enumerate}
...
Let $B=B_{R}\left(y\right)$ be the sphere of the inner sphere condition.
\begin{align*}
