...
Consider $u\in H^{1,2}\left(\Omega\right)$ and choose $h<\text{dist}\left(\Omega',\partial\Omega\right)$.
Then holds $\Delta_{i}^{h}u\in L^{2}\left(\Omega'\right)$ and:
\begin{align*}
\norm{\Delta_{i}^{h}u}_{L^{2}\left(\Omega'\right)} & \le\norm{\partial_{i}u}_{L^{2}\left(\Omega\right)}
\end{align*}
...
and thus:
\begin{align*}
\norm{\Delta_{i}^{h}u}_{L^{2}\left(\Omega'\right)}^{2} & \le\frac{1}{h}\underbrace{\int_{0}^{h}\dd\xi}_{=h}\int_{\Omega}\dd^{n}x\abs{\partial_{i}u}^{2}=\int_{\Omega}\dd^{n}x\abs{\partial_{i}u}^{2}=\norm{\partial_{i}u}_{L^{2}\left(\Omega\right)}^{2}
\end{align*}
\qqed
...
and for $v=\upDelta u$:
\begin{align*}
\int\left(\nabla u\right)\left(\nabla\left(\upDelta u\right)\right)\dd^{n}x & =\int\left(\partial_{i}u\right)\partial^{i}\partial_{j}\partial^{j}u\dd^{n}x\sr ={\text{integration}}{\text{by parts}}-\int\left(\partial^{j}\partial_{i}u\right)\partial^{i}\partial_{j}u\dd^{n}x=-\int\norm{\DD^{2}u}^{2}\dd^{n}x
\end{align*}
