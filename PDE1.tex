...
\begin{align*}
0 & =\frac{\dd}{\dd t}S\left(u+\tau\eta\right)\big|_{\tau=0}=\\
...
For a minimizer $u$, $S\left(u+\tau v\right)$ is minimal at $\tau=0$.
This is a polynomial in $\tau$ and thus holds:
\begin{align*}
0 & =\frac{\dd}{\dd\tau}S\left(u+\tau v\right)\big|_{\tau=0}=\frac{\dd}{\dd\tau}\left(A\left(u+\tau v,u+\tau v\right)+l\left(u+\tau v\right)\right)\big|_{\tau=0}=2A\left(u,v\right)+l\left(v\right)
\end{align*}
\qqed
